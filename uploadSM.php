...
if ($uploadOk == 0) {
    // Do nothing here, the message will already be set by the specific error condition
} else {
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO study_material (course_code, file_name, file_path) VALUES ('$courseCode', '$fileName', '$filePath')";
