...
if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        if ( empty($paper_id) || empty($course_code) || empty($content_LinkHref) || empty($admin_id)) {
            $errorMessage = "All the fields are required";
            break;
        }

        //add new user to database
        $sql = "INSERT INTO past_year_paper (paper_id, course_code, content_LinkHref, admin_id) " . 
                "VALUES ('$paper_id', '$course_code', $content_LinkHref', '$admin_id')";
