...
if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    do {
        if ( empty($tutor_id) || empty($tutor_password) || empty($tutor_name) || empty($tutor_phone) || empty($tutor_email) || empty($admin_id)) {
            $errorMessage = "All the fields are required";
            break;
        }

        //add new user to database
        $sql = "INSERT INTO tutor (tutor_id, tutor_password, tutor_name, tutor_phone, tutor_email, admin_id) " . 
                "VALUES ('$tutor_id', '$tutor_password', '$tutor_name', '$tutor_phone', '$tutor_email', '$admin_id')";
