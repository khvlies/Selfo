...
try {
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Check if 'online_id' is set
        if (isset($_POST['online_id'])) {
            $id = $_POST['online_id']; // ID to delete (VARCHAR)
        } else {
        ...
        if ($stmt->affected_rows > 0) {
            // Record deleted successfully, redirect to listOnlineSession.php
    ...
    <div class="container my-5">
        ...
        <form method="post" onsubmit="return confirmDelete()">
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="Online" value="">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-secondary" href="/SLMS2/listOnlineSession.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
