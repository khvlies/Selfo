...
--
-- Host: 127.0.0.1
-- Generation Time: May 31, 2024 at 09:43 AM
...
('AD01', 'admin1', 'ad@01', 136409816, 'admin1@gmail.com'),
('AD02', 'admin2', 'ad@02', 118906654, 'admin2@gmail.com'),
('AD03', 'admin3', 'ad@03', 179527791, 'admin3@gmail.com'),
('AD04', 'admin4', 'ad@04', 128805632, 'admin4@gmail.com');
...
('BU01', 'bal080', 'Iqbaal Ramadhani', 122964080, 'iqbaal@gmail.com', 'NT05', 'PP05', 'AD01'),
('BU02', 'idhm729', 'Mohd Idham', 145562729, 'idham@gmail.com', 'YT02', 'PP07', 'AD01'),
('BU03', 'nur114', 'Nur Sakinah', 165710114, 'sakinah@gmail.com', 'NT03', 'PP03', 'AD01'),
('BU04', 'sha505', 'Elly Elysha', 163531505, 'elly@gmail.com', 'NT02', 'PP02', 'AD01'),
...
('BU07', 'ainul106', 'Ainul Aiza', 154216106, 'ainul@gmail.com', 'NT04', 'PP04', 'AD04'),
('BU08', 'ira349', 'Syafirah Adira', 109257349, 'adira@gmail.com', 'YT04', 'PP09', 'AD04'),
('BU09', 'ain053', 'Ain Nadira', 194865053, 'ainnad@gmail.com', 'YT05', 'PP10', 'AD04'),
('BU10', 'wan697', 'Wan Syarmila', 102639697, 'syarmila@gmail.com', 'NT01', 'PP01', 'AD04'),
('BU11', 'bla000', 'Try Je haa', 148890077, 'tryje@gmail.com', 'NT02', 'PP03', 'AD02');
...
CREATE TABLE `past_year_paper` (
  ...
  `admin_id` varchar(5) DEFAULT NULL,
  `content_LinkHref` varchar(2083) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `past_year_paper` (`paper_id`, `course_code`, `admin_id`, `content_LinkHref`) VALUES
('PP01', 'CSC126', 'AD02', ' Final_Dec_2018_CSC126.pdf'),
('PP02', 'CSC186', 'AD02', 'Final_July_2018_CSC186.pdf'),
('PP03', 'CS248', 'AD02', 'Final_Feb_2020_CSC248.pdf'),
('PP04', 'MAT133', 'AD02', 'Final_Feb_2019_MAT133.pdf'),
('PP05', 'MAT183', 'AD02', 'Final_Jan_2023_MAT183.pdf'),
('PP06', 'ICT200', 'AD04', 'Final_July_2023_ICT200.pdf'),
('PP07', 'ITT320', 'AD04', 'Final_Dec_2019_ITT320.pdf'),
('PP08', 'CSC207', 'AD04', 'Final_Jan_2024_CSC207.pdf'),
('PP09', 'MAT210', 'AD04', 'Final_Feb_2022_MAT210.pdf'),
('PP10', 'CSC305', 'AD04', 'Final_Dec_2019_CSC305.pdf');
...
('PU01', 'syu123', 'Syuhada Natasya', 145678367, 'syuhada@gmail.com', 'AD02', 'NT03', 'PP03', 'TU01'),
('PU02', 'amir2324', 'Amir Hilman', 128907765, 'hilman@gmail.com', 'AD02', 'YT04', 'PP09', 'TU01'),
('PU03', 'ray456', 'Raysha Maheera', 102334478, 'raysha@gmail.com', 'AD02', 'NT05', 'PP05', 'TU02'),
('PU04', 'yasun926', 'Andau Yasun', 136729926, 'andau@gmail.com', 'AD02', 'NT01', 'PP01', 'TU03'),
('PU05', 'wei169', 'Zhang Wei', 131571169, 'zhangwei@gmail.com', 'AD02', 'YT05', 'PP10', 'TU04'),
('PU06', 'syed462', 'Syed Haikal', 199892462, 'haikal@gmail.com', 'AD03', 'NT02', 'PP02', 'TU05'),
('PU07', 'azhar484', 'Azhar Matusin', 195016484, 'azhar@gmail.com', 'AD03', 'NT02', 'PP02', 'TU05'),
('PU08', 'hardy331', 'Mohd Hardy', 157842331, 'hardy@gmail.com', 'AD03', 'NT04', 'PP04', 'TU02'),
('PU09', 'nala172', 'Ishita Anala', 170541172, 'anala@gmail.com', 'AD03', 'YT02', 'PP07', 'TU03'),
('PU10', 'kim458', 'Daniel Hakim', 179781458, 'daniel@gmail.com', 'AD03', 'YT03', 'PP08', 'TU01');
...
CREATE TABLE `study_material` (
  ...
  `admin_id` varchar(5) DEFAULT NULL,
  `course_code` varchar(7) DEFAULT NULL,
  `pdf_link` varchar(2083) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `study_material` (`study_id`, `admin_id`, `course_code`, `pdf_link`) VALUES
('NT01', 'AD01', 'CSC126', 'ASSIGNMENT 126.pdf'),
('NT02', 'AD01', 'CSC186', 'ASSIGNMENT 126.pdf'),
('NT03', 'AD01', 'CSC248', 'ASSIGNMENT 126.pdf'),
('NT04', 'AD01', 'MAT133', 'ASSIGNMENT 126.pdf'),
('NT05', 'AD01', 'MAT183', 'ASSIGNMENT 126.pdf'),
('YT01', 'AD03', 'ICT200', 'https://youtu.be/2K5RWMOBOQs?si=IV3YRvrtv9akdg_b'),
('YT02', 'AD03', 'ITT320', 'https://youtu.be/2K5RWMOBOQs?si=IV3YRvrtv9akdg_b'),
('YT03', 'AD03', 'CSC207', 'https://youtu.be/2K5RWMOBOQs?si=IV3YRvrtv9akdg_b'),
('YT04', 'AD03', 'MAT210', 'https://youtu.be/2K5RWMOBOQs?si=IV3YRvrtv9akdg_b'),
('YT05', 'AD03', 'CSC305', 'https://youtu.be/2K5RWMOBOQs?si=IV3YRvrtv9akdg_b');
...
('TU01', 'sitiB246', 'Siti Bahiyah', 147483647, 'sbahiyah@gmail.com', 'AD04'),
