...
try {
    ...
    // Retrieve and sanitize user input
        ...
        $answer_LinkHref = $conn->real_escape_string($_POST['answer_LinkHref']);
        $admin_id = $conn->real_escape_string($_POST['admin_id']);

    // Prepare an update statement
        $stmt = $conn->prepare("UPDATE past_year_paper SET course_code = ?, content_LinkHref = ?, answer_LinkHref = ?, admin_id = ? WHERE paper_id = ?");
        $stmt->bind_param("ssssssss", $course_code, $content_LinkHref, $answer_LinkHref, $admin_id, $paper_id);
