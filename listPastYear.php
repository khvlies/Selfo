...
<body>
    ...
    <div class="container my-5">
        ...
        <a class="btn btn-secondary" href="/SLMS2/addPastYear.php" role="button">Add Past Year</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()){
                    ...
                    <td>
                        ...
                        <a class='btn btn-success btn-sm' href='/SLMS2/downloadStudyMaterial.php?file_id={$row['paper_id']}'>Download</a>
                    </td>
                </tr>";
                }
                ?>
